...
<small>예) 조회 - 수정 - 조회 과정에서 중간에 삭제가 동시에 이루어지면 수정 후 조회의 값이 의도와 달라진다.</small>
</br></br>
...
<READ UNCOMMITTED - DIRTY READ 이미지>
...
<READ COMMITTED - NON-REPEATABLE READ 이미지>
